...
if (!IS_ADMIN_FLAG && $_SESSION['ups_low'] <= 49.00 && $_SESSION['ups_low'] != 0) {
  $this->enabled = false;
}
...
if ($_SESSION['ups_low'] <= 49.00 && $_SESSION['ups_low'] != 0) {
// skip it
//echo 'FLAT quote SKIPIT $chk_ups_cost: ' . $chk_ups_cost . ($chk_ups_cost <= 49 ? ' YES LOWER!' : ' NO HIGHER') . ($_SESSION['ups_low'] <= 49 ? ' ups_low YES LOWER: ' : ' ups_low NO HIGHER: ') . $_SESSION['ups_low'] . '<br>';
} else {
//echo 'FLAT quote SHOWIT $chk_ups_cost: ' . $chk_ups_cost . ($chk_ups_cost <= 49 ? ' YES LOWER!' : ' NO HIGHER') . ($_SESSION['ups_low'] <= 49 ? ' ups_low YES LOWER: ' : ' ups_low NO HIGHER: ') . $_SESSION['ups_low'] . '<br>';
